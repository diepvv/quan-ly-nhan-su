...
<form id="formTest" method="post" action="#" class="valida" autocomplete="off" novalidate="novalidate">
	...
	<div class="row">
		<div class="col-md-3">
			<div class="form-group">
				<label for="donViChucNang_pk">Đơn vị công tác</label>
	...
	<div class="row">
		<div class="col-md-3">
			<div class="form-group">
				<label for="ten" class="label-style">Tên Cán Bộ</label> 
				<input class="form-control" id="ten" type="text" required="true">
			</div>
		</div>
		<div class="col-md-3">
			<label for="tenGoiKhac" class="label-style">Tên Gọi Khác</label> 
			<input class="form-control" id="tenGoiKhac" type="text">
		</div>
		<div class="col-md-3">
	...
	<div class="row">
		<div class="col-md-3">
			...
			<input class="form-control" id="noiSinh" type="text">
		</div>
		<div class="col-md-3">
			<div class="form-group">
				<label for="queQuan_pk">Quê quán</label>
				<c:if test="${not empty queQuanLists}">
					<select class="form-control my-select-control-style" id="queQuan_pk" required="true">
	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<input class="form-control" id="noiCapCmnd" type="text">
		</div>
		<div class="col-md-3">
			<label for="noiDKHoKhauThuongTru">Nơi đăng ký hộ khẩu thường trú</label> 
			<input class="form-control" id="noiDKHoKhauThuongTru" type="text">
		</div>
	</div>

	<div class="row">
		<div class="col-md-3">
			<label for="noiOHienNay">Nơi ở hiện nay</label> 
			<input class="form-control" id="noiOHienNay" type="text">
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-3">
			<label for="coQuanTuyenDung">Cơ quan tuyển dụng</label> 
			<input class="form-control" id="coQuanTuyenDung" type="text">
		</div>
		<div class="col-md-3">
	...
	<div class="row">
		...
		<div class="col-md-3">
			<label for="congViecDuocGiao">Công việc chính được giao</label> 
			<input class="form-control" id="congViecDuocGiao" value="Giảng dạy" type="text">
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-3">
			<div class="form-group">
				<label for="ngachCongChuc_pk">Ngạch công chức</label>
	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<input class="form-control" id="phuCapKhac" type="text">
		</div>
		<div class="col-md-3">
			<label for="trinhDoGiaoDucPt">Trình độ giáo dục phổ thông</label> 
			<input class="form-control" id="trinhDoGiaoDucPt" type="text">
		</div>
		<div class="col-md-3">
			<label for="trinhDoChuyenMon">Trình độ chuyên môn cao nhất</label> 
			<input class="form-control" id="trinhDoChuyenMon" type="text">
		</div>
	</div>

	<div class="row">
		<div class="col-md-3">
			<label for="hocVi" class="label-style">Học Vị</label> 
			<input class="form-control" id="hocVi" type="text">
		</div>
		<div class="col-md-3">
			<label for="ngayNhanHocVi" class="label-style">Ngày nhận học vị</label>
			<div class="input-group date" data-provide="datepicker">
		...
		<div class="col-md-3">
			<label for="hocHam" class="label-style">Học Hàm</label> 
			<input class="form-control" id="hocHam" type="text">
		</div>
		<div class="col-md-3">
			<label for="ngayNhanHocHam" class="label-style">Ngày nhận học hàm</label>
			<div class="input-group date" data-provide="datepicker">
	...
	<div class="row">
		<div class="col-md-3">
			<label for="lyLuanChinhTri">Lý luận chính trị</label> 
			<input class="form-control" id="lyLuanChinhTri" type="text">
		</div>
		<div class="col-md-3">
			<label for="quanLyNhaNuoc">Quản lý nhà nước</label> 
			<input class="form-control" id="quanLyNhaNuoc" type="text">
		</div>
		<div class="col-md-3">
			<label for="ngoaiNgu">Anh Văn</label> 
			<input class="form-control" id="ngoaiNgu" type="text">
		</div>
		<div class="col-md-3">
			<label for="tinHoc">Tin học</label> 
			<input class="form-control" id="tinHoc" type="text">
		</div>
	</div>

	<div class="row">
		<div class="col-md-3">
			<label for="ngayVaoDcsvnDuBi" class="label-style">Ngày vào đảng cộng sản Việt Nam dự bị</label>
			<div class="input-group date" data-provide="datepicker">
		...
		<div class="col-md-3">
			<label for="ngayVaoDcsvnChinhThuc" class="label-style">Ngày vào đảng cộng sản Việt Nam chính thức</label>
			<div class="input-group date" data-provide="datepicker">
		...
		<div class="col-md-3">
			<label for="thamGiaToChucCtxh" class="label-style">Tham gia tổ chức chính trị xã hội</label> 
			<input class="form-control" id="thamGiaToChucCtxh" type="text">
		</div>
		<div class="col-md-3">
	...
	<div class="row">
		...
		<div class="col-md-3">
			<label for="quanHamCaoNhat">Quân hàm cao nhất</label> 
			<input class="form-control" id="quanHamCaoNhat" type="text">
		</div>
		<div class="col-md-3">
			<label for="danhHieuPhongTang">Danh hiệu được phong tặng cao nhất</label> 
			<input class="form-control" id="danhHieuPhongTang" type="text">
		</div>
		<div class="col-md-3">
			<label for="soTruongCongTac">Số trường công tác giảng dạy</label> 
			<input class="form-control" id="soTruongCongTac" type="text">
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<input class="form-control" id="khenThuong" type="text">
		</div>
		<div class="col-md-3">
			<label for="kyLuat">Kỷ luật</label> 
			<input class="form-control" id="kyLuat" type="text">
		</div>
		<div class="col-md-3">
			<label for="tinhTrangSucKhoe">Tình trạng sức khỏe</label> 
			<input class="form-control" id="tinhTrangSucKhoe" type="text">
		</div>
		<div class="col-md-3">
			<label for="chieuCao">Chiều cao</label> 
			<input class="form-control" id="chieuCao" type="text">
		</div>
	</div>

	<div class="row">
		<div class="col-md-3">
			<label for="canNang" class="label-style">Cân nặng</label> 
			<input class="form-control" id="canNang" type="text">
		</div>
		<div class="col-md-3">
			<label for="nhomMau" class="label-style">Nhóm máu</label> 
			<select class="form-control my-select-control-style" id="nhomMau">
		...
		<div class="col-md-3">
			<label for="soBaoHiemXh" class="label-style">Số bảo hiểm xã hội</label> 
			<input class="form-control" id="soBaoHiemXh" type="text">
		</div>
		<div class="col-md-3">
	...
	<div class="row">
		<div class="col-md-3">
			<label for="laConGiaDinhChinhSach" class="label-style">Là con gia đình chính sách</label> 
