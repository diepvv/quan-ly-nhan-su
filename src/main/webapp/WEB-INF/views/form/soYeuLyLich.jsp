...
<form id="formTest" method="post" action="#" class="valida">
	<div class="form-group">
		...
		<div class="row">
			<div class="col-md-3">
				<label for="tenNgach" class="label-style">Tên ngạch công
					chức viên chức</label> <input class="form-control" id="tenNgach"
					type="text">
			</div>
			<div class="col-md-3">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<label for="ngayNhanHocHam" class="label-style">Ngày nhận
					học hàm</label>
				<div class="input-group date" data-provide="datepicker">
		...
		<div class="row">
			<div class="col-md-3">
				<label for="laConGiaDinhChinhSach" class="label-style">Là
					con gia đình chính sách</label> <input class="form-control"
