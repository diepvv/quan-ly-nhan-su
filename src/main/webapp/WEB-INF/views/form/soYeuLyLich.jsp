...
<div id="collapseSoYeuLyLich" class="panel-collapse collapse">
	...
	<div class="row">
		<div class="col-md-3">
			<label for="inputdefault">Nơi sinh</label> <input
				class="form-control" id="txtNoisinh" type="text">
		</div>
		<div class="col-md-3">
			<label for="inputdefault">Quê quán</label> <input
	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<input class="form-control" id="txtDanhHieuPhongTang" type="text">
		</div>
		<div class="col-md-3">
	...
	<div class="row">
		<div class="col-md-3">
			<label for="inputdefault">Cân nặng</label> <input
				class="form-control" id="txtCanNang" type="text">
		</div>
		<div class="col-md-3">
			<label for="inputdefault">Nhóm máu</label> <input
				class="form-control" id="txtNhomMau" type="text" list="listNhomMau">
